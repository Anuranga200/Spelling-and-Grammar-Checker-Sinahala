...
# Test the function
input_text = "සුමම පසලට ගියෙමි. ගුරුතුමා පඩම පැවැත්වූයේය . මම ගැටලුව විසඳීමට ඉස්සරහට ගියෙමි. මගේ මිතුර පසු බලා සිටියේය. අපි ගණත ක‍්‍රම ඉගෙන ගත්තෙමු."  # Intentional errors for testing
